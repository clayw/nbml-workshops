...
# This function generates linearly-separable data in two dimensions.
...
sample_linear_data = function(a, b, c, xmin, xmax, ymin, ymax, npts)
{
...
c = 0.05
npts = 100
trainingData = sample_linear_data(a, b, c, -2, 2, -2, 2, npts)

#visualize the sample data
plot_data(trainingData, "Linearly Seperable Training Data")

#train a simple linear SVM on the data
svmModel = svm(cls ~ ., data=trainingData, kernel="linear")
summary(svmModel)
