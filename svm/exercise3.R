#This example uses a more complex nonlinear decision boundary
# and introduces C-SVM regularization.
...
#train a simple linear SVM on the data. Play with different values
# of the regularization parameter "C" and see how predictions do.
# Higher values of C penalize deviations from the training data
# more, which hurts the ability to predict test data. Lower values
# of C have the opposite effect.
svmModel = svm(cls ~ ., data=trainingData, kernel="radial", C=10)
summary(svmModel)
